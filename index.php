                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/delivery-rider.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/Banner-moto-delivery_VF-02.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/silde-3.jpg" alt="">
                            </div>
							<div class="item">
                                <img class="img-responsive img-full" src="img/delivery.jpg" alt="">
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
					...
					Copyright &copy; Entrega Delivery
					</p>
					<strong></strong>
