<?php
	...
	}else if($ProductAction == "Edit")
	{
		...
		if($res)
		{
			echo '<script>window.alert("El producto se ha actualizado correctamente!"); window.open("Management_ProductsList.php","_self",null,true)</script>';
		}
	}else if($ProductAction == "Delete")
	{
		...
		if($res)
		{
			echo '<script>window.alert("El producto se ha eliminado correctamente!"); window.open("Management_ProductsList.php","_self",null,true)</script>';
		}
	}
