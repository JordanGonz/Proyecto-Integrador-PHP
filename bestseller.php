...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<li><a href="index.php">Inicio</a></li>
					<li><a href="bestseller.php" class="activo">Productos más Populares</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Entregas Delivery</p>
                </div>
            </div>
        </div>
    </footer>
	...
	<script>
		...
		{	
			if(confirm("¿Está seguro de que desea añadir este producto a su cesta?") == true){
